...
- Math graph: 772 topics across 18 strands (K-8, MA-caliber density). Prereq density 1.46/topic, encompassing density 0.96/topic. See `docs/archive/expansion-map.md` for MA cross-reference.
