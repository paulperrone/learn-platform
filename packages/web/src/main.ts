...
const router = createRouter({
  ...
  routes: [
    ...
    { path: "/diagnostic/:subjectId", component: () => import("./pages/diagnostic.vue") },
    ...
    { path: "/explore/:subjectId/:topicId", component: () => import("./pages/explore-topic.vue") },
    ...
    { path: "/teach/:subjectId/:topicId", component: () => import("./pages/teach-topic.vue") },
    { path: "/graph", component: () => import("./pages/explore.vue"), meta: { requiresAuth: true } },
